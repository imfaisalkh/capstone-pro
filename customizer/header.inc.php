...
#-------------------------------------------------------------------------------#
	...
	function capstone_customize_header_settings() {
		...
		Kirki::add_section( 'capstone_header_settings', array(
            'title'          => esc_html__( 'Header Settings', 'capstone' ),
            'description'    => esc_html__( 'This section configure settings for the site header.', 'capstone' ),
            'priority'       => 20,
        ) );
		...
		Kirki::add_field( 'capstone_header_primary_logo_width', array(
			...
			'label'       => __( 'Primary Logo Width', 'capstone' ),
			'description'    => esc_html__( 'This option only applies to primary image logo.', 'capstone' ),
		...
		Kirki::add_field( 'capstone_header_dashboard_logo_width', array(
			...
			'label'       => __( 'Dashboard Logo Width', 'capstone' ),
			'description'    => esc_html__( 'This option only applies to dashboard image logo.', 'capstone' ),
			'section'     => 'capstone_header_settings',
			'default'     => '52',
		) );
		...
		Kirki::add_field( 'capstone_header_vertical_padding', array(
			...
			'label'       => __( 'Header Vertical Padding', 'capstone' ),
			'description'    => esc_html__( 'Adjust the number to increase/decrease header height.', 'capstone' ),
			'section'     => 'capstone_header_settings',
			'default'     => '20',
		) );
