...
#-------------------------------------------------------------------------------#
	...
	function capstone_customize_geolocation_settings() {
		...
		Kirki::add_section( 'capstone_geolocation_settings', array(
            'title'          => esc_html__( 'Geolocation Settings', 'capstone' ),
            'description'    => esc_html__( 'This section configure settings for the geolocation elements.', 'capstone' ),
            'priority'       => 70,
        ) );
        ...
        Kirki::add_field( 'capstone_map_default_coordinates', array(
            ...
            'label'    => __( 'Map Default Location', 'capstone' ),
            'default'    => '-0.12775829999998223, 51.5073509',
            'section'  => 'capstone_geolocation_settings',
            'description' => esc_html__('Default GPS coordinates (latitude, longitude). Get them from here', 'capstone'),
        ) );
        ...
        Kirki::add_field( 'capstone_mapbox_access_token', array(
            ...
            'label'    => __( 'Mapbox Access Token', 'capstone' ),
            'section'  => 'capstone_geolocation_settings',
            'description' => esc_html__('Get FREE token for your mapbox account and paste it here.', 'capstone'),
        ) );
