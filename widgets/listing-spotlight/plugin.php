...
// TODO: change 'Capstone_Widgets' to the name of your plugin
class Capstone_Widgets extends WP_Widget {
...
// TODO: Remember to change 'Capstone_Widgets' to match the class name definition
register_activation_hook( __FILE__, array( 'Capstone_Widgets', 'activate' ) );
register_deactivation_hook( __FILE__, array( 'Capstone_Widgets', 'deactivate' ) );
